...
@Service public class ContactServiceImpl implements ContactService
{
	...
	@Autowired public ContactServiceImpl(ContactRepository contactRepository,
	...
	@Override public Page<ContactDto> findAllContacts(int page, int size)
	{
	...
	@Override public ContactDto findContactById(String id)
	{
		final UUID uuid;
		try
		{
	...
	@Override public ContactDto saveContact(ContactDto dto)
	{
	...
	@Override public ContactDto updateContact(String id, ContactDto dto)
	{
	...
	@Override public Page<ContactDto> findContactsByNameContainsIgnoreCase(String text, int page, int size)
	{
	...
	@Override public Page<ContactDto> findContactsByWebsiteContainsIgnoreCase(String text, int page, int size)
	{
		final Page<Contact> contacts =
	...
	@Override public Page<ContactDto> findContactsByNoteContainsIgnoreCase(String text, int page, int size)
	{
		final Page<Contact> contacts =
	...
	@Override public Page<ContactDto> findContactsByTelephoneContains(String number, int page, int size)
	{
		final Page<Contact> contacts = contactRepository.findContactsByTelephoneContains(number, PageRequest.of(page, size));
		return contacts.map(DtoMapper::fromContactToContactDto);
	}

	@Override public Page<ContactDto> findContactsByAddressContainsIgnoreCase(String text, int page, int size)
	{
		final Page<Contact> contacts = contactRepository.findContactsByAddressContainsIgnoreCase(text, PageRequest.of(page, size));
		return contacts.map(DtoMapper::fromContactToContactDto);
	}

	@Override public Page<ContactDto> findContactsByEmailContainsIgnoreCase(String text, int page, int size)
	{
		final Page<Contact> contacts =
