...
public interface ContactController {
	...
	ResponseEntity<EntityModel<ContactDto>> findContactById(
	...
	ResponseEntity<EntityModel<ContactDto>> saveContact(
	...
	ResponseEntity<EntityModel<ContactDto>> updateContact(
			@PathVariable("id") String id,
			@RequestBody ContactDto dto,
			HttpServletRequest httpServletRequest
	);
	...
	@DeleteMapping("/{id}")
	ResponseEntity<Void> deleteContact(@PathVariable("id") String id, HttpServletRequest httpServletRequest);
