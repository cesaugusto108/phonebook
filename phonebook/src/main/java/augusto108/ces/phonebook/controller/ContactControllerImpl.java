...
public class ContactControllerImpl implements ContactController {
    ...
    @Override
    public ResponseEntity<PagedModel<EntityModel<ContactDto>>> findAllContacts(
            int page,
            int size,
    ...
    @Override
    public ResponseEntity<EntityModel<ContactDto>> findContactById(String id, HttpServletRequest httpServletRequest) {
        final String httpMethod = httpServletRequest.getMethod();
    ...
    @Override
    public ResponseEntity<EntityModel<ContactDto>> saveContact(ContactDto dto, HttpServletRequest httpServletRequest) {
        final String httpMethod = httpServletRequest.getMethod();
    ...
    @Override
    public ResponseEntity<EntityModel<ContactDto>> updateContact(
            String id,
            ContactDto dto,
            HttpServletRequest httpServletRequest
    ) {
    ...
    @Override
    public ResponseEntity<Void> deleteContact(String id, HttpServletRequest httpServletRequest) {
    ...
    @Override
    public ResponseEntity<PagedModel<EntityModel<ContactDto>>>
