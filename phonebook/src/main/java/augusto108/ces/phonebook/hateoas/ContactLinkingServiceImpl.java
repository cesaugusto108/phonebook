...
@Service public class ContactLinkingServiceImpl implements ContactLinkingService
{

	private final ContactService contactService;
	private final PagedResourcesAssembler<ContactDto> assembler;

	@Autowired public ContactLinkingServiceImpl(ContactService contactService, PagedResourcesAssembler<ContactDto> assembler)
	{
		this.contactService = contactService;
		this.assembler = assembler;
	}

	@Override public PagedModel<EntityModel<ContactDto>> findAllContacts(int page, int size)
	{
		return assemblePagedModel(() -> contactService.findAllContacts(page, size));
	}

	@Override public EntityModel<ContactDto> findContactById(String id)
	{
		return getEntityModel(() -> contactService.findContactById(id));
	}

	@Override public EntityModel<ContactDto> saveContact(ContactDto dto)
	{
		return getEntityModel(() -> contactService.saveContact(dto));
	}

	@Override public EntityModel<ContactDto> updateContact(String id, ContactDto dto)
	{
		return getEntityModel(() -> contactService.updateContact(id, dto));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByNameContainsIgnoreCase(String text, int page, int size)
	{
		return assemblePagedModel(() -> contactService.findContactsByNameContainsIgnoreCase(text, page, size));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByWebsiteContainsIgnoreCase(String text, int page, int size)
	{
		return assemblePagedModel(() -> contactService.findContactsByWebsiteContainsIgnoreCase(text, page, size));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByNoteContainsIgnoreCase(String text, int page, int size)
	{
		return assemblePagedModel(() -> contactService.findContactsByNoteContainsIgnoreCase(text, page, size));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByTelephoneContains(String number, int page, int size)
	{
		return assemblePagedModel(() -> contactService.findContactsByTelephoneContains(number, page, size));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByAddressContainsIgnoreCase(String text, int page, int size)
	{
		return assemblePagedModel(() -> contactService.findContactsByAddressContainsIgnoreCase(text, page, size));
	}

	@Override public PagedModel<EntityModel<ContactDto>> findContactsByEmailContainsIgnoreCase(String text, int page, int size)
	{
	...
	@FunctionalInterface private interface ContactEntityFunctionalInterface
	{
		ContactDto getContact();
	}

	@FunctionalInterface private interface ContactsPageFunctionalInterface
	{
